			...
			<div id="content">
				...
				<div class="container-fluid">
					...
					<div class="card shadow mb-4">
						...
						<!-- Card Body -->
						<div class="card-body">
							<form action="<?= base_url('admin/proses_riwayat_peralatan_update')?>" method="post">
								<!-- Columns are always 50% wide, on mobile and desktop -->
								<div class="row">
                                <?php foreach($list_riwayat_peralatan as $d){ ?>
									<div class="col-6">
										<div class="form-group">
											<label for="nama_perlatan">Nama Peralatan</label>
                                            <input type="hidden" name="id_riwayat_peralatan" value="<?=$d->id_riwayat_peralatan?>">
											<input type="text" name="nama_perlatan"
												style="margin-left:25px;width:50%;display:inline;" required
												class="form-control form_datetime" placeholder="Nama Peralatan" value="<?=$d->nama_peralatan?>">
										</div>
									</div>
									<div class="col-6">
										<div class="form-group">
											...
											<option value="<?=$d->kategori_peralatan?>"><?=$d->kategori_peralatan?></option>
                                    ...
                                    <div class="col-6">
										<div class="form-group">
											...
											<input type="text" name="merk"
												...
												class="form-control form_datetime" placeholder="Merk" value="<?=$d->merk?>">
										</div>
									</div>
                                    <div class="col-6">
										<div class="form-group">
											...
											<input type="text" name="type"
												...
												class="form-control form_datetime" placeholder="Type" value="<?=$d->type?>">
										</div>
									</div>
                                    <div class="col-6">
										<div class="form-group">
											...
											<input type="text" name="daya"
												style="margin-left:105px;width:50%;display:inline;" required
												class="form-control form_datetime" placeholder="Daya" value="<?=$d->daya?>">
										</div>
									</div>
                                    <div class="col-6">
										<div class="form-group">
											...
											<input type="text" name="frequency"
												...
												class="form-control form_datetime" placeholder="Frequency" value="<?=$d->frequency?>">
										</div>
									</div>
                                    <div class="col-6">
										<div class="form-group">
											...
											<input type="text" name="volume"
												style="margin-left:85px;width:50%;display:inline;" required
												class="form-control form_datetime" placeholder="Volume" value="<?=$d->volume?>">
										</div>
									</div>
									<div class="col-6">
										<div class="form-group">
											...
											<select class="form-control" name="satuan"
												style="margin-left:110px;width:50%;display:inline;">
												<?php foreach($list_satuan as $s){?>
												<?php if($d->id_satuan == $s->id_satuan){?>
												<option value="<?=$d->id_satuan?>" selected=""><?=$s->nama_satuan?></option>
												<?php }else{?>
									...
									<div class="col-6">
										<div class="form-group">
											...
											<input type="text" name="kondisi"
												style="margin-left:85px;width:50%;display:inline;" required
												class="form-control form_datetime" placeholder="Kondisi" value="<?=$d->kondisi?>">
										</div>
									</div>
									<div class="col-6">
										<div class="form-group">
											...
											<input type="date" name="tanggal_input"
												style="margin-left:65px;width:50%;display:inline;" required
												class="form-control form_datetime" value="<?=$d->tanggal_input?>">
										</div>
									</div>
                                    <?php } ?>
								</div>
