					...
					<div class="row">
						...
						<div class="col-xl-3 col-md-6 mb-4">
							<div class="card border-left-primary shadow h-100 py-2">
									...
									<div class="row no-gutters align-items-center">
										<div class="col mr-2">
											<div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
												Stok Barang Keluar</div>
											<?php if(!empty($stokBarangKeluar)){ ?>
											<?php foreach($stokBarangKeluar as $d){?>
											<div class="h5 mb-0 font-weight-bold text-gray-800"><?=$d->jumlah?></div>
											<?php } ?>
											<?php }else{?>
								...
								<div class="card-footer">
									<a href="<?=base_url('admin/tabel_barangkeluar')?>" class="small-box-footer"> More
						...
						<div class="col-xl-3 col-md-6 mb-4">
							<div class="card border-left-success shadow h-100 py-2">
								...
								<div class="card-footer">
									<a href="<?=base_url('admin/tabel_barangmasuk')?>" class="small-box-footer">More
										info <i class="fa fa-arrow-circle-right"></i></a>
								</div>
							</div>
						</div>
									...
									<div class="row no-gutters align-items-center">
										<div class="col mr-2">
											<div class="text-xs font-weight-bold text-warning text-uppercase mb-1">
												Invoice Manual</div>
											<div class="h5 mb-0 font-weight-bold text-gray-800">Make an Invoice</div>
										</div>
										<div class="col-auto">
