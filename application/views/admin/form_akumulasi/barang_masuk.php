		...
		<div id="content-wrapper" class="d-flex flex-column">
			...
			<div id="content">
				...
				<div class="container-fluid">
					<!-- Page Heading -->
					<h3 class="box-title"><i class="fa fa-table" aria-hidden="true"></i> Akumulasi Barang Masuk</h3>
					<!-- DataTales Example -->
					<div class="card shadow mb-4">
						<div class="card-body">
						<form action="<?= base_url('admin/generate_akumulasi_barang_masuk')?>" method="post">
							...
							<div class="alert alert-success alert-dismissible" style="width:100%">
								...
								<?php echo $this->session->flashdata('msg_berhasil_masuk');?>
							</div>
							<?php } ?>
							<div class="col-6">
