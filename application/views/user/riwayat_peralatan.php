				...
				<div class="container-fluid">
					...
					<div class="card shadow mb-4">
						<div class="card-body">
							...
							<a href="<?=base_url('user/form_riwayat_peralatan_insert')?>" style="margin-bottom:10px;" type="button"
									...
									<tbody>
										<tr>
											...
											<td><a type="button" class="btn btn-info"
													href="<?=base_url('user/form_riwayat_peralatan_update/'.$dd->id_riwayat_peralatan)?>"
											...
											<!-- <td><a type="button" class="btn btn-danger btn-delete"
													href="<=base_url('user/delete_riwayat_peralatan/'.$dd->id_riwayat_peralatan)?>"
	...
	<div class="modal fade" id="deleteModal<?=$dd->id_riwayat_peralatan;?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				...
				<form action="<?=base_url('user/delete_riwayat_peralatan/'.$dd->id_riwayat_peralatan)?>">
