								...
								<div class="row">
									<div class="col-6">
										<div class="form-group">
											<?php foreach($data_barang_masuk_header as $key => $d){ ?>
									...
									<div class="table-responsive" style="overflow-x:scroll;">
										...
										<table class="table table-bordered" id="dataTable" width="100%" style="overflow-x:scroll;">
											<thead>
												<tr>
											...
											<tbody id="AddBarangDetail">
												<?php $tableRowIndex = 0;
												foreach ($data_barang_masuk_detail as $key) { $tableRowIndex++ ?>
													<tr id="<?=$tableRowIndex?>">
