				...
				<div class="container-fluid">
					...
					<div class="card shadow mb-4">
						<div class="card-body">
							...
							<a href="<?=base_url('admin/form_barangkeluar')?>" style="margin-bottom:10px;" type="button"
								class="btn btn-primary" name="tambah_data"><i class="fa fa-plus-circle"
									aria-hidden="true"></i> Tambah Barang Keluar</a>
							<a href="<?=base_url('report/barangKeluarManual')?>" style="margin-bottom:10px;"
								type="button" class="btn btn-danger" name="laporan_data"><i class="fas fa-file-alt"
									aria-hidden="true"></i> Invoice Manual</a>
									...
									<tbody>
										<tr>
											...
											<td><a type="button" class="btn btn-info"
													href="<?=base_url('admin/detail_barang_keluar/'.$dd->id_transaksi)?>"
													name="btn_update"><i class="fas fa-search" aria-hidden="true"></i></a></td>
	...
	<div class="modal fade" id="deleteModal<?=$dd->id_transaksi;?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				...
				<form action="<?=base_url('admin/delete_barang_keluar/'.$dd->id_transaksi)?>">
