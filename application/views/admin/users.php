...
<body id="page-top">
		...
		<div id="content-wrapper" class="d-flex flex-column">
			...
			<div id="content">
				...
				<div class="container-fluid">
					<!-- Page Heading -->
					<h3 class="box-title"><i class="fa fa-table" aria-hidden="true"></i> Table Users</h3>
									...
									<tbody>
										<tr>
											...
											<td><a type="button" class="btn btn-info"
													href="<?=base_url('admin/update_user/'.$dd->UserID)?>" name="btn_update"
													style="margin:auto;"><i class="fas fa-pen"
														aria-hidden="true"></i></a></td>
											<td><a class="btn btn-danger btn-delete" data-toggle="modal" data-target="#deleteModal<?=$dd->UserID;?>"><i class="fa fa-trash"
														aria-hidden="true"></i></a></td>
											<!-- <td><a type="button" class="btn btn-danger btn-delete"
													href="<?=base_url('admin/proses_delete_user/'.$dd->UserID)?>"
	...
	?>
	<div class="modal fade" id="deleteModal<?=$dd->UserID;?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
		aria-hidden="true">
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				<div class="modal-header">
				...
				<form action="<?=base_url('admin/proses_delete_user/'.$dd->UserID)?>">
