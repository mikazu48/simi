...
<li class="nav-item">
    ...
    <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities"
        ...
        <div class="bg-white py-2 collapse-inner rounded">
            <h6 class="collapse-header">Transaksi:</h6>
            <a class="collapse-item" href="<?php echo base_url('user/tabel_barangmasuk')?>">TRX Barang Masuk</a>
            <a class="collapse-item" href="<?php echo base_url('user/tabel_barangkeluar')?>">TRX Barang Keluar</a>
            <a class="collapse-item" href="<?php echo base_url('user/riwayat_peralatan')?>">Riwayat Peralatan</a>
        </div>
    </div>
</li> 
