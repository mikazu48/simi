						...
						<div class="col-md-6">
							...
							<div class="tab-content">
								...
								<div class="tab-pane" id="picture">
									<form class="form-horizontal" action="<?=base_url('user/proses_gambar_upload')?>"
										method="post" enctype="multipart/form-data">

										<div class="form-group">
											<label for="picture" class="col-sm-4 control-label">Open
												Picture</label>
								...
								<div class="tab-pane active" id="settings">
									<form class="form-horizontal" action="<?=base_url('user/proses_new_password')?>"
										method="post">
