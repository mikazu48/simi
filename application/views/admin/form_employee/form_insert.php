			...
			<div id="content">
				...
				<div class="container-fluid">
					...
					<div class="d-sm-flex align-items-center justify-content-between mb-4">
						<!-- <h1 class="h3 mb-0 text-gray-800">Form Insert Employee</h1>
					...
					<div class="card shadow mb-4">
						...
						<div class="card-body">
							...
							<!-- Content Row -->
							<form action="<?= base_url('admin/proses_tambah_employee')?>" method="post">
								<div class="row">
									<div class="col-6">
									...
									<div class="col-6">
										<div class="form-group">
											...
											<input type="text" name="alamat"
												...
												class="form-control form_datetime" placeholder="Alamat">
										</div>
									</div>
									<div class="col-6">
										<div class="form-group">
